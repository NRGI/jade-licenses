...
//                this.dom.input.value = "Boo";

//              console.log(this.dom.input.value);
...
//              console.log(this.dom);
	        ...
	        value: function setValue(value) {
              ...
              // Yan added: get the output tranform function
	            var transformOutput = this.config.transform.output;
              ...
              // Yan added: check to see if the date is being reset
              if (value == "reset") {
                // Yan added: change the date value in the DOM input box to "" 
                //  and datepicker's value to ""
                this.dom.input.value = "";
//                var todayTemp = Datepicker.getStateFromToday();
//                this.value = transform(todayTemp.year + "-" + (todayTemp.monthIndex + 1) + "-" + todayTemp.today);
                this.value = "";
              } else {
                this.value = transform(value);
                // Yan added: change the date value in the DOM input box
                this.dom.input.value = transformOutput(value);
              }
